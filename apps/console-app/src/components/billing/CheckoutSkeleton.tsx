/**
 * @fileoverview Skeleton placeholder matching the Stripe-style checkout layout.
 */
export default function CheckoutSkeleton() {
  return (
    <div className="min-h-screen lg:grid lg:grid-cols-2">
      <div className="min-h-screen bg-[#f6f9fc] lg:shadow-[1px_0_0_0_#e6ebf1]">
        <div className="mx-auto flex h-full w-full max-w-xl flex-col px-6 py-12 sm:px-8 sm:py-14 lg:ml-auto lg:mr-0 lg:max-w-2xl lg:px-16 lg:py-16 xl:px-20">
          ...
          <div className="mt-auto h-3 w-48 animate-pulse rounded bg-[#e6ebf1] pt-10" />
        </div>
      </div>

      <div className="min-h-screen bg-white">
        <div className="mx-auto w-full max-w-xl px-6 py-12 sm:px-8 sm:py-14 lg:ml-0 lg:mr-auto lg:max-w-2xl lg:px-16 lg:py-16 xl:px-20">
