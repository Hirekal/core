...
export class AuthService {
   ...
   * @param emailsService - Outbound email logging
   ...
   * @returns Created user, organization, and email verification code
   */
  ...
  async updateProfile(userId: string, dto: UpdateProfileDto): Promise<User> {
    try {
      ...
      if (dto.password !== undefined) profilePatch.password = dto.password;
  ...
  /**
   * Initiates a password reset by generating and logging a reset code.
   *
